  ...
  <div class="navbar-wrap">
    <ul class="navbar-nav">
      <li class="nav-item nav-about">
        <a class="nav-link btn--slide-hover" href="<?php echo $root ?>/about" title="About">About</a>
      </li>
      <li class="nav-item nav-contact">
        <a class="nav-link btn--slide-hover" href="<?php echo $root ?>/contact" title="Contact">Contact</a>
      </li>
